...
<div style="width:100%;height:100%;position: relative;" class="text-center">
 <form class="form-signin text-center" action="LoginValidator" method="post" style="width:4in; display: inline-block;padding-top: 8em;" >
      <img class="mb-4" src="images/logoonly.png" alt="" width="72" height="72">
